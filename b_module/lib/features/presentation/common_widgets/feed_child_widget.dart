...
import 'package:b_module/features/presentation/common_widgets/favorite_button_widget.dart';
import 'package:b_module/features/presentation/common_widgets/like_button_widget.dart';
...
class _FeedChildWidgetState extends State<FeedChildWidget> {
  ...
  Widget _getFavoriteButton() {
    return FavoriteButtonWidget(
      isFavorite: widget.feedModel.isFavorite, // 0 means false, 1 means true
