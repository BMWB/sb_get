...
class FeedBloc extends Bloc<FeedEvent, FeedState> {
  ...
  _mapGetAllFeedState(final GetAllFeedsEvent getAllFeedsEvent,
    ...
    result.fold((l) => emit(FeedErrorState()),
        (r) => add(AllFeedEventLoaded(r) /*emit(FeedLoadedState(r)*/));
  }

  _mapAllFeedLoadedState(
      final AllFeedEventLoaded eventLoaded, final Emitter<FeedState> emit) {
